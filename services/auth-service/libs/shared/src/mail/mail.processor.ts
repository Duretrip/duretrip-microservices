...
import { CONFIRM_REGISTRATION, FORGOT_PASSWORD, MAIL_QUEUE } from 'libs/shared/src/constants';
import { ForgotPasswordMailInterface, MailJobInterface } from 'libs/shared/src/interfaces';
